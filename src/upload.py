...
def issue_request(method, endpoint, *args, **kwargs):
    # Avoid this impure function of BASE_URL
...
def create_article(article_title):
    ...
    print ('Created article:', response['location'], '\n')
    return response

def get_article_by_id(article_id):
    '''article_id: str or int'''
    if article_id is str: article_id = str(article_id) 
    return issue_request('GET', f'account/articles/{article_id}')
